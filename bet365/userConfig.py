...
RULE_FULL = {
    ...
    'all_bets_info': {
        'already_goals': {
            5: {'goal_cancel_forbidden': False, 'one_party_zero_allow': True, 'last_half_goals': [2, 3, 4],
                 'latest_goal_times': {'min': 45, 'max': 75}, 'next_half_first_goal_times': {'min': 45, 'max': 75},
                'first_goal_times': {'min': 0, 'max': 30}, 'all_parties_goals_minus':{'min':5, 'max':5},
            },
