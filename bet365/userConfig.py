...
RULE_FULL = {
    ...
    'all_bets_info': {
        'already_goals': {
            ...
            5: {'goal_cancel_forbidden': True, 'last_half_goals': {'min': 1, 'max': 4}, 'latest_goal_times': {'min': 45, 'max': 80},
            ...
            6: {'goal_cancel_forbidden': True, 'last_half_goals': {'min': 4, 'max': 5}, 'latest_goal_times': {'min': 45, 'max': 75},
